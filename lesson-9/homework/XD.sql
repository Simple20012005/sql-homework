...
SELECT e1.EmployeeID AS Employee1_ID, e1.Name AS Employee1_Name, e1.DepartmentID AS Dept1,
       e2.EmployeeID AS Employee2_ID, e2.Name AS Employee2_Name, e2.DepartmentID AS Dept2
FROM Employees e1
...
where p.Amount<>pr.Price*o.Quantity
...
SELECT DISTINCT m.EmployeeID, m.Name AS ManagerName, m.Salary AS ManagerSalary
FROM Employees m
