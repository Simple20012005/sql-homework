create database F33_homework11
...
select o.OrderID,c.FirstName CustomerName,o.OrderDate from Orders o 
...
select c.FirstName CustomerName,o.OrderID,o.OrderDate from Customers c
...
select c.FirstName CustomerName,count(o.OrderID) TotalOrders  from Customers c
...
select c.FirstName CustomerName, max(o.orderDate) MostRecentOrderDate from Customers c
left join Orders o on c.CustomerID=o.CustomerID
...
select c.FirstName CustomerName, sum(o.Totalamount) OrderTotal from Customers c
...
select c.FirstName CustomerName, o.OrderID, c.Address, o.OrderDate from Customers c
join Orders o on c.CustomerID=o.CustomerID
...
select c.CategoryName,count(p.category) from Products p
...
select c.FirstName CustomerName,c.City,o.OrderID,o.TotalAmount Amount  from Customers c
join Orders o on o.CustomerID=c.CustomerID
...
Select e.name EmployeeName, d.DepartmentName from Employees e
join Departments d on d.DepartmentID=e.DepartmentID
where d.DepartmentName='Human Resources' or d.DepartmentName='Finance' or 
