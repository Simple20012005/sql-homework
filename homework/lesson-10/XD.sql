create database F33_homework_lesson10

use F33_homework_lesson10
...
select s.name as StudentName,c.CourseName from Enrollments e
...
select d.DepartmentName,count(e.departmentid) EmployeeCount from Employees e
...
where d.DepartmentID is not null and e.DepartmentID is not null
