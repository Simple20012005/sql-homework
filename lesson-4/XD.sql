...
--Since there is no column named Department in the Employees table, I had to use DepartmentName.
...
--Since there is no column named Stock in the products table, I had to use StockQuantity.
...
Select *from Products
where Price<(select avg(Price)from Products)/10
